...
First install the `datamgmt` package.  This will also load `dataone`.    
```{r}
...
This is a better option (than the first method) if you would like to prefix your data files (in addition to metadata) with the DOI identifier.  
<br>
