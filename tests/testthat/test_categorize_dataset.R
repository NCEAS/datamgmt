  ...
  stringsAsFactors = FALSE,
      ...
      dateUploaded = c("2020-05-15 19:51:23",
          ...
          abstract = c("The files contain mitochondrial gene sequence data for individual zooplankton (Calanus spp. And Thysanoessa spp.) collected near Barrow, AK. The files are Fasta files that can be opened in most bioinformatics software programs (e.g. Geneious, MegAlign, MEGA) or text/word processing programs. For each sequence, the file contains the species identification, isolate number, station number, collection location (Lat, Lon), collection date, the sequenced gene followed by the sequence.",
                       ...
                       "This dataset represents zooplankton data collected from Chaun Bay, Russia, 1986. Characteristics of distribution and seasonal variations in the composition and members of the dominant zooplankton typical of the Chaun Bay are shown.Only predominant species are included for both abundance and biomass estimates. Thus null values may not be zero but rather not recorded as taxa is not dominant. Samples were collected with a Juday net of 163 um mesh size and mouth opening diameter of 0.75 meters. The samples were fixed in a 4% formalin solution."),
          keywords = c("EARTH SCIENCE > BIOSPHERE > AQUATIC ECOSYSTEMS > PLANKTON > ZOOPLANKTON SHIP STATION 10 KILOMETERS TO 50 KILOMETERS DAILY TO WEEKLY oceans",
                       ...
                       "EARTH SCIENCE > BIOLOGICAL CLASSIFICATION > ANIMALS/INVERTEBRATES IN SITU/LABORATORY INSTRUMENTS > SAMPLERS > TRAWLS/NETS > BONGO NETS SHIP STATION UNKNOWN biota"),
             title = c("Zooplankton Genetics 2013",
                       ...
                       "Zooplankton of Chaun Bay (East-Siberian Sea), Russia, 1986"),
            ...
            theme3 = c(NA, NA, NA, NA, NA, NA, NA),
            theme4 = c(NA, NA, NA, NA, NA, NA, NA),
            theme5 = c(NA, NA, NA, NA, NA, NA, NA),
             coder = c("Erin","Erin","Erin","Erin",
                       "test pid","test pid","test pid")
)
